...
def main():
 ...
 for name in names:
  ...
  m=measure_backend(b,0,a.warmup,a.iterations,a.repeats_per_sample); d=m.to_dict(); d.update(backend=name,correctness={'correct':ok},metadata=b.metadata()); results.append(d); print(f'{name:30s} median={m.median_us:.3f} us')
